...
# Keep-alive: update existing `sudo` time stamp until `.set_default.sh` has finished
...
# Display short POSIX path as Finder window title
...
# Prevent auto download apps purchased on other Macs
